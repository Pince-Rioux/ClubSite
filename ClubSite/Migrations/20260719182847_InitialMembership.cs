        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusChangeDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClubMemberships_AspNetRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmergencyContactInfo = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Preferences = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    SpecialNeeds = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ProfileUpdated = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClubMembershipId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubscriptionHistory", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubscriptionHistory_AspNetRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SubscriptionHistory_ClubMemberships_ClubMembershipId",
            ...
            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "CreatedOn", "Description", "DisplayName", "IsActive", "LastModified", "Name", "NormalizedName", "Rank" },
                values: new object[,]
                {
                    { "admin", null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Full system administrator", "Administrator", true, null, "Admin", "ADMIN", 100 },
                    { "guest", null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Guest access", "Guest", true, null, "Guest", "GUEST", 1 },
                    { "member", null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Regular club member", "Member", true, null, "Member", "MEMBER", 10 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionHistory_ClubMembershipId",
                table: "SubscriptionHistory",
                column: "ClubMembershipId");

            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionHistory_RoleId",
                table: "SubscriptionHistory",
                column: "RoleId");
